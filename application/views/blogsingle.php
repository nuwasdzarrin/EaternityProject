        ...
        <div class="col-md-9">
            ...
            <div class="blog-item">
                ...
                <div class="blog-post-body row margin-top-15">
                    <div class="col-md-5">
                        <img class="pull-left" src="<?php echo base_url('assets/uploads/'); echo $key->gambar;?>" alt="image1">
                    </div>
                    <div class="col-md-7">
                    ...
                    <blockquote class="primary">
                        ...
                        <p>Ut summo deserunt sit, quaeque hendrerit assentior cu mei. Sale electram nam ut. Putent perpetua reformidans ex vix, libris nostrud tractatos cu sit, est porro omnes nominati eu. Cu nullam similique complectituream. Viris phaedrum ullamcorper id eos.</p>
                    </div>
                </div>
                <div class="blog-item-footer">
                    ...
                    <div class="blog-author panel panel-default margin-bottom-30">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-2">
                                <img class="pull-left" src="<?php echo base_url();?>assetsvirtuoso/img/profiles/87.jpg" alt="image1">
                                </div>
                                <div class="col-md-10">
                                <label>John Doe</label>
                                <p>Lorem ipsum dolor sit amet, in prioffendit ocurreret. Vix sumo ferri an. pfs adodio fugit delenit ut qui. Omittam suscipiantur ex vel,ex audiam intellegat gfIn labitur discere eos, nam an feugiat voluptua.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <ul class="list-group">
                            <li class="list-group-item">
                                <div class="row">
                                    ...
                                    <a href="#"><img class="media-object" src="<?php echo base_url();?>assetsvirtuoso/img/profiles/99.jpg" alt=""></a>
                                    </div>
                                    <div class="col-md-10"><h4>Great Article</h4>
                            ...
                            <li class="list-group-item">
                                <div class="row">
                                    <div class="col-md-2 profile-thumb">
                                        <a href="#"><img class="media-object" src="<?php echo base_url();?>assetsvirtuoso/img/profiles/53.jpg" alt=""></a>
                                    </div>
                                    <div class="col-md-10">
                            ...
                            <li class="list-group-item">
                                <div class="row">
                                    <div class="col-md-2 profile-thumb">
                                        <a href="#"><img class="media-object" src="<?php echo base_url();?>assetsvirtuoso/img/profiles/37.jpg" alt=""></a>
                                    </div>
                                    <div class="col-md-10">
                                        <h4>Thank you!</h4>
                                        <p>At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua.</p>
                                        <span class="date"><i class="fa fa-clock-o"></i>10 May 2013</span>
                                    </div>
                                </div>
                            </li>
                            <!-- Comment Form -->
                            <li class="list-group-item">
                                <div class="blog-comment-form">
                                    <div class="row margin-top-20">
                                        <div class="col-md-12">
                                            <div class="pull-left"><h3>Leave a Comment</h3></div>
                                        </div>
                                    </div>
                                    <div class="row margin-top-20">
                                        <div class="col-md-12">
                ...
                <ul class="posts-list margin-top-10">
                    <li>
                        <div class="recent-post">
                            <a href=""><img class="pull-left" src="<?php echo base_url();?>assetsvirtuoso/img/blog/thumbs/thumb1.jpg" alt="thumb1"></a>
                    ...
                    <li>
                        <div class="recent-post">
                            <a href=""><img class="pull-left" src="<?php echo base_url();?>assetsvirtuoso/img/blog/thumbs/thumb2.jpg" alt="thumb2"></a>
                            <a href="#" class="posts-list-title">Sidebar post example</a>
                            <br>
                            <span class="recent-post-date">July 30, 2013</span>
                        </div>
                    ...
                    <li>
                        <div class="recent-post">
                            <a href=""><img class="pull-left" src="<?php echo base_url();?>assetsvirtuoso/img/blog/thumbs/thumb3.jpg" alt="thumb3"></a>
                            <a href="#" class="posts-list-title">Sidebar post example</a>
                            <br>
                            <span class="recent-post-date">July 30, 2013</span>
                        </div>
                    ...
                    <li>
                        <div class="recent-post">
                            <a href=""><img class="pull-left" src="<?php echo base_url();?>assetsvirtuoso/img/blog/thumbs/thumb4.jpg" alt="thumb4"></a>
                            <a href="#" class="posts-list-title">Sidebar post example</a>
                            <br>
                            <span class="recent-post-date">July 30, 2013</span>
                        </div>
