                                        ...
                                        <div class="media-body">
                                            <div class="media">
                                                <a class="pull-left" href="#">
                                                    <img class="media-object img-circle img-comments" src="<?php echo base_url();?>/assets/img/user.png" />
                                                </a>
                                                <div class="media-body">
                                                    ...
                                                    <div class="media">
                                                        <a class="pull-left" href="#">
                                                            <img class="media-object img-circle img-comments" src="<?php echo base_url();?>/assets/img/user.gif" />
                                                        </a>
                                                        <div class="media-body">
