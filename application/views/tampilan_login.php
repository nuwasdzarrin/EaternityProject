...
<body style="background-color: #E2E2E2;">
    <div class="container">
        <div class="row text-center " style="padding-top:100px;">
            <div class="col-md-12">
                <img src="<?php echo base_url();?>/assetsf/logo.png" />
            </div>
        </div>
         <div class="row ">
                ...
                <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 col-xs-10 col-xs-offset-1">
                            ...
                            <div class="panel-body">
                                <form role="form" method="post" action="<?php echo base_url('index.php/login/cek_login');?>">
                                    <hr/>
                                    ...
                                    <div class="form-group">
                                     ...
                                     <button type="submit" class="btn btn-primary "><i class="icon-key"></i>Login Now</button> 
                                    <hr />
